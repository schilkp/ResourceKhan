...
void test_complex_1(void) {
  assert_tree_state();
  pwr_tree_enable_client(&c_f);
  assert_tree_state();
  pwr_tree_disable_client(&c_f);
  assert_tree_state();
}

void test_complex_2(void) {
  assert_tree_state();
  pwr_tree_enable_client(&c_g1);
  assert_tree_state();
  pwr_tree_enable_client(&c_g2);
  assert_tree_state();
  pwr_tree_disable_client(&c_g1);
  assert_tree_state();
  pwr_tree_disable_client(&c_g2);
  assert_tree_state();
}

void test_many_parent_nodes(void) {
  assert_tree_state();
  pwr_tree_enable_client(&c_many);
  assert_tree_state();
  pwr_tree_disable_client(&c_many);
  assert_tree_state();
  pwr_tree_enable_client(&c_many);
  assert_tree_state();
  pwr_tree_enable_client(&c_e);
  assert_tree_state();
  pwr_tree_enable_client(&c_d);
  assert_tree_state();
}
